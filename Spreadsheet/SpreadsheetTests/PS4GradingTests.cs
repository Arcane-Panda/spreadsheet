...
namespace GradingTests
{
  ...
  public class SpreadsheetTest
  {
    ...
    public void TestStress4()
    {
            ...
            //    lastCells.AddFirst("A1" + (i + 2));
            //}
            //Assert.IsTrue(s.SetCellContents("A11", 25.0).SequenceEqual(firstCells));
            //Assert.IsTrue(s.SetCellContents("A13", 0).SequenceEqual(lastCells));
